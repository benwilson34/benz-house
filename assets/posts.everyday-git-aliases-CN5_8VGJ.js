import{j as s}from"./jsx-runtime-BMrMXMSG.js";import{f as i,A as t}from"./ArticleHeader-BHYaRTsD.js";const a={title:"everyday Git aliases to speed up your workflow",datePublished:"2021-04-05T00:00:00-05:00",dateUpdated:"2024-12-18T00:00:00-05:00"},h=()=>[{title:i(a.title)}];function l(n){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...n.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h1,{children:a.title}),`
...
`,s.jsx(e.h2,{children:"the short list"}),`
...
`]})}),`
`,s.jsx(e.h2,{children:"the full list"}),`
...
`]})}),`
`,s.jsx(e.h2,{children:"explanations & usage examples"}),`
`,s.jsx(e.h3,{children:"adding & discarding changes"}),`
`,s.jsx(e.pre,{children:s.jsxs(e.code,{className:"hljs language-ini",children:[s.jsx(e.span,{className:"hljs-attr",children:"s"}),` = status
`,s.jsx(e.span,{className:"hljs-attr",children:"discard"}),` = checkout --
`,s.jsx(e.span,{className:"hljs-attr",children:"discardall"}),` = reset --hard HEAD
`,s.jsx(e.span,{className:"hljs-attr",children:"forget"}),` = rm --cached
...
`]}),`
`,s.jsx(e.h3,{children:"committing"}),`
...
`]}),`
`,s.jsx(e.h3,{children:"viewing commits/changes"}),`
...
`]}),`
`,s.jsx(e.h2,{children:"conclusion"}),`
...
`,s.jsx(e.p,{children:"Maybe I'll write a longer form article about how I set that up on my Windows machine with hard links... 🤔"})]})}function d(n={}){const{wrapper:e}=n.components||{};return e?s.jsx(e,{...n,children:s.jsx(l,{...n})}):l(n)}export{d as default,h as meta};
