...
`,e.jsx(n.h2,{children:"step 1: edit registry"}),`
...
`]}),`
`,e.jsx(n.h2,{children:"step 2: edit group policies"}),`
...
`]}),`
`,e.jsx(n.h2,{children:"step 3: edit task schedules"}),`
`,e.jsxs(n.p,{children:["This step might only be relevant for Windows 10 Pro installations (not Windows 10 Home). You can check by pressing ",e.jsx(n.strong,{children:"Win+X"})," then ",e.jsx(n.strong,{children:"Y"}),", then look under ",e.jsx(n.strong,{children:"“Windows specifications → Edition”"}),"."]}),`
`,e.jsxs(n.ol,{children:[`
...
`]}),`
`]}),`
`,e.jsx(n.h2,{children:"step 4: restart"}),`
...
`,e.jsx(n.h2,{children:"from now on"}),`
...
`]})]})}function a(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{a as default,h as meta};
